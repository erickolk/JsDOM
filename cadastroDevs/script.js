function createLabel(text, hmtlFor) {
    const label = document.createElement('label')
    label.htmlFor = hmtlFor
...
addSkill.addEventListener('click', function(ev) {
    ...
    newRow.append(
        techNameLabel,
        techNameInput,
        expLabel, expRadio1,expLabel1,expRadio2,expLabel2,expRadio3,expLabel3,removeRowBtn
    )
